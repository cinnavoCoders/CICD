...
import { getEmployee, selectEmployee, selectEmployeeSearchText } from '../store/EmployeeSlice';
import EmployeeTableHead from './EmployeeTableHead';

function EmployeeTable(props) {
  const dispatch = useDispatch();
  const products = useSelector(selectEmployee);
  ...
  useEffect(() => {
    dispatch(getEmployee()).then(() => setLoading(false));
  }, [dispatch]);
              ...
              .map((n) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="p-4 md:p-16 flex justify-center items-center" component="th" scope="row" align="center">
                      {n.active ? (
